...
public class CalendarGUI extends javax.swing.JFrame {
	...
	//Swap 1, TEAM 01 Called a method (above) to remove duplicate code throughout the three methods below QUALITY CHANGE 2
	/**
	...
	public void fillTableForThisMonth() {
		...
		while (this.currentMonth == this.cal.get(Calendar.MONTH) + 1) {
			...
			if (this.scheduleMap.containsKey(tempKey)) {
				...
				//Swap 1 TEAM 01 QUALITY CHANGE 2
				String numDate = makeNumDate(this.cal.get(Calendar.MONTH) + 1, this.cal.get(Calendar.DAY_OF_MONTH), this.cal.get(Calendar.YEAR));
